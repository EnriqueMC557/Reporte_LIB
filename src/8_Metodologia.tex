...
%	Flecha azul (eje Y) representa movimientos horizontales; Flecha roja (eje X) representa movimientos verticales; Flecha verde (eje Z) representa movimientos hacia arriba y abajo. 
